...
public:
    ...
    virtual void on_draw()
    {
        ...
        typedef agg::renderer_scanline_p_solid<renderer_base> sbool_renderer_type;
        ...
        ras.render(sl, r);
        ras.render_ctrl(sl, r, m_trans_type);
        ras.render_ctrl(sl, r, m_reset);
        ras.render_ctrl(sl, r, m_mul1);
        ras.render_ctrl(sl, r, m_mul2);
        //--------------------------
