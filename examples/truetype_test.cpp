...
//m_feng.flip_y(false);
    ...
    virtual void on_draw()
    {
        ...
        ras.render_ctrl(sl, ren_solid, m_ren_type);
        ras.render_ctrl(sl, ren_solid, m_height);
        ras.render_ctrl(sl, ren_solid, m_width);
        ras.render_ctrl(sl, ren_solid, m_weight);
        ras.render_ctrl(sl, ren_solid, m_gamma);
        ras.render_ctrl(sl, ren_solid, m_hinting);
        ras.render_ctrl(sl, ren_solid, m_kerning);
        ras.render_ctrl(sl, ren_solid, m_performance);
    }
