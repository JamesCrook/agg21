...
public:
    ...
    virtual void on_draw()
    {
        ...
        agg::renderer_scanline_u_solid<amask_ren_type> rs(r);
        agg::renderer_scanline_u_solid<base_ren_type>  rb(rbase);
        ...
        g_rasterizer.render_all_paths(g_scanline, rs, trans, g_colors, g_path_idx, g_npaths);
        ...
        agg::renderer_scanline_u<amask_ren_type, span_grad_type> rg(r, sg);
        for(i = 0; i < 50; i++)
        {
            x = rand() % width;
            y = rand() % height;
            ...
            ell.init(x, y, r, r, 32);
            g_rasterizer.add_path(ell);
            g_rasterizer.render(g_scanline, rg);
        }

        g_rasterizer.render_ctrl(g_scanline, rb, m_num_cb);
    }
