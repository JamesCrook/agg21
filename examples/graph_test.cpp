...
typedef agg::renderer_scanline_p_solid<base_renderer>   solid_renderer;
...
typedef agg::renderer_scanline_u<base_renderer, 
...
public:
        ...
        switch(m_draw)
        {
            ...
            case 3:
            {
                ...
                if(m_type.cur_item() < 4)
                {
                    ...
                    ras.render(m_sl, ren_fine);
                }
                else
                {
                    ren_draft.color(agg::rgba8(r, g, b, a));
                    ras.render(m_sl, ren_draft);
                }
            }
            break;
        }
    ...
    virtual void on_draw()
    {
        ...
        ras.render_ctrl(m_sl, solid, m_type);
        ras.render_ctrl(m_sl, solid, m_width);
        ras.render_ctrl(m_sl, solid, m_benchmark);
        ras.render_ctrl(m_sl, solid, m_draw_nodes);
        ras.render_ctrl(m_sl, solid, m_draw_edges);
        ras.render_ctrl(m_sl, solid, m_draft);
        ras.render_ctrl(m_sl, solid, m_translucent);
    }
