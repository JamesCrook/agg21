...
public:
    ...
    virtual void on_draw()
    {
        ...
        ras_aa.render_ctrl(m_sl_p8, ren_aa, m_gamma);
        ras_aa.render_ctrl(m_sl_p8, ren_aa, m_alpha);
        ras_aa.render_ctrl(m_sl_p8, ren_aa, m_test);
    }
