...
public:
        ...
        if(m_operation.cur_item() > 0)
        {
            ...
            switch(m_scanline_type.cur_item())
            {
                case 0:
                {
                    ...
                    ras1.render(sl, storage1);
                    ras2.render(sl, storage2);
            ...
            agg::renderer_scanline_p_solid<renderer_base> ren(rb);
            agg::scanline_p8 sl;
            agg::gsv_text txt;
    ...
    unsigned render_sbool(Rasterizer& ras1, Rasterizer& ras2)
    {
        ...
        agg::renderer_scanline_p_solid<agg::renderer_base<pixfmt_type> > ren(rb);
        agg::scanline_p8 sl;
    ...
    virtual void on_draw()
    {
        ...
        ras.render_ctrl(sl, ren_solid, m_polygons);
        ras.render_ctrl(sl, ren_solid, m_fill_rule);
        ras.render_ctrl(sl, ren_solid, m_scanline_type);
        ras.render_ctrl(sl, ren_solid, m_operation);
