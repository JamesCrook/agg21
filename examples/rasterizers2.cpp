...
public:
    ...
    typedef agg::renderer_scanline_p_solid<renderer_base> renderer_aa;
    ...
    virtual void on_draw()
    {
        ...
        ras_aa.render_ctrl(sl, ren_aa, m_step);
        ras_aa.render_ctrl(sl, ren_aa, m_width);
        ras_aa.render_ctrl(sl, ren_aa, m_test);
        ras_aa.render_ctrl(sl, ren_aa, m_rotate);
        ras_aa.render_ctrl(sl, ren_aa, m_accurate_joins);
        ras_aa.render_ctrl(sl, ren_aa, m_scale_pattern);
