...
public:
    ...
    virtual void on_draw()
    {
        ...
        g_rasterizer.render_all_paths(g_scanline, r, trans_lens, g_colors, g_path_idx, g_npaths);

        g_rasterizer.render_ctrl(g_scanline, r, m_magn_slider);
        g_rasterizer.render_ctrl(g_scanline, r, m_radius_slider);
    }
