...
*/
        ...
        agg::renderer_scanline_u<renderer_base, gradient_span_gen> rg(rb, span_gradient);
        ...
        pf.render_ctrl(sl, rs, m_amplitude);
        pf.render_ctrl(sl, rs, m_period);
        pf.render_ctrl(sl, rs, m_distortion);
    }
