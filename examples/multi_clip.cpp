...
public:
    ...
    virtual void on_draw()
    {
        ...
        base_ren_type r(pf);
        agg::renderer_scanline_u_solid<base_ren_type> rs(r);
...
//            g_rasterizer.render(g_scanline, rs);
//        }
//    }
//}
        ...
        agg::renderer_scanline_u<base_ren_type, span_grad_type> rg(r, sg);
        for(i = 0; i < 50; i++)
        {
            x = rand() % width;
            y = rand() % height;
        ...
        g_rasterizer.render_ctrl(g_scanline, rs, m_num_cb);
    }
