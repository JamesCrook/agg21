...
public:
    ...
    void perform_rendering(VertexSource& vs)
    {
        ...
        agg::renderer_scanline_p_solid<amask_ren_type> ren(rbase);
    ...
    virtual void on_draw()
    {
        ...
        typedef agg::renderer_scanline_p_solid<base_ren_type> renderer_solid;
        ...
        m_ras.render_ctrl(m_sl, ren_solid, m_polygons);
        m_ras.render_ctrl(m_sl, ren_solid, m_operation);
    }
